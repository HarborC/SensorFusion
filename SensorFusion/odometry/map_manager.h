...
public:
    using Ptr = std::shared_ptr<MAP_MANAGER>;
     ...
     */
    static void pointAssociateToMap(
     ...
     * added to map \param[in] laserCloudSurfStack: surf feature points that
     * need to be added to map \param[in] transformTobeMapped: transform matrix
     * of the lidar pose
     */
    void MapIncrement(
     ...
     * retrieved from map \param[in] transformTobeMapped: transform matrix of
     * the lidar pose
     */

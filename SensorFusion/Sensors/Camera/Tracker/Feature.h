...
public:
    ...
    /// UV normalized coordinates that this feature has been seen from (mapped
    /// by camera ID)
     ...
     *
     * Given a series of valid timestamps, this will remove all measurements
     * that have not occurred at these times. This would normally be used to
     * ensure that the measurements that we have occur at our clone times.
     *
     * @param valid_times Vector of timestamps that our measurements must occur
     * at
     */
     ...
     *
     * @param invalid_times Vector of timestamps that our measurements should
     * not
     */

...
Camera::Parameters::Parameters(ModelType modelType)
    ...
    switch (modelType) {
    case KANNALA_BRANDT: m_nIntrinsics = 8; break;
    case PINHOLE: m_nIntrinsics = 8; break;
    case SCARAMUZZA: m_nIntrinsics = SCARAMUZZA_CAMERA_NUM_PARAMS; break;
    case LADYBUG: m_nIntrinsics = 27; break;
    case MEI:
    default: m_nIntrinsics = 9;
    }
}

...
public:
    ...
    DynamicInitializer(const double& td_, const Eigen::Matrix3d& Ma_,
        ...
        : td(td_),
          ...
          RIC(R_c2b),
          TIC(t_bc_b),
          imu_img_timeTh(imu_img_timeTh_),
    ...
    // If initialized.
    bool ifInitialized() { return bInit; }
...
private:
    ...
    // Check if the condition is fit to conduct the vio initialization, and
    // conduct it while suitable.

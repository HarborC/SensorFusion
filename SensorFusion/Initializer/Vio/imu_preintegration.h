...
public:
    ...
    IntegrationBase(const Eigen::Vector3d &_acc_0,
                    ...
                    const Eigen::Vector3d &_linearized_bg, const double &acc_n,
                    const double &acc_w, const double &gyr_n,
                    const double &gyr_w)
        : acc_0{_acc_0},
          gyr_0{_gyr_0},
    ...
    void midPointIntegration(
        ...
        if (update_jacobian) {
            ...
            R_a_0_x << 0, -a_0_x(2), a_0_x(1), a_0_x(2), 0, -a_0_x(0),
                -a_0_x(1), a_0_x(0), 0;
            R_a_1_x << 0, -a_1_x(2), a_1_x(1), a_1_x(2), 0, -a_1_x(0),
                -a_1_x(1), a_1_x(0), 0;
            ...
            F.block<3, 3>(0, 9) = -0.25 *
                                  (delta_q.toRotationMatrix() +
                                   result_delta_q.toRotationMatrix()) *
                                  _dt * _dt;
    ...
    void propagate(double _dt, const Eigen::Vector3d &_acc_1,
        ...
        midPointIntegration(_dt, acc_0, gyr_0, _acc_1, _gyr_1, delta_p, delta_q,
                            delta_v, linearized_ba, linearized_bg,
                            result_delta_p, result_delta_q, result_delta_v,
                            result_linearized_ba, result_linearized_bg, 1);

        // checkJacobian(_dt, acc_0, gyr_0, acc_1, gyr_1, delta_p, delta_q,
        // delta_v,
    ...
    Eigen::Matrix<double, 15, 1> evaluate(
        ...
        Eigen::Quaterniond corrected_delta_q =
            delta_q * getSmallAngleQuaternion(dq_dbg * dbg);
